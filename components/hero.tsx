    ...
    <section className="min-h-[90vh] px-6 sm:px-8 lg:px-12 flex flex-col items-center justify-center text-center">
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
        ...
        <div className="space-y-3 sm:space-y-4">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light tracking-tight text-gray-950 leading-[1.1]">
            {t('title')}
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-gray-500 font-light">
            {t('subtitle')}
          </p>
        </div>
