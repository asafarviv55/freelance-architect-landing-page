...
export default function TermsOfUse() {
  ...
  const content = {
    en: {
      ...
      section1Text: "By accessing architectflow.vercel.app (\"the Website\"), you agree to these Terms of Use. If you do not agree, please discontinue using the Website.",
    ...
    he: {
      ...
      section1Text: "בעת גישה לאתר architectflow.vercel.app (\"האתר\"), אתם מסכימים לתנאי שימוש אלה. אם אינכם מסכימים, אנא הפסיקו להשתמש באתר.",
